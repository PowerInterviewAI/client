...
**Lost the window?** Launch Power Interview again. It does not start a second copy - the running app brings its window back and focuses it. `Ctrl+Shift+R` (`Ctrl+Opt+R` on macOS) does the same without leaving the keyboard.
